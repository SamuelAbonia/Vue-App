  ...
  <div class="registerContent">
      <v-container>
          <v-row class="mx-2" justify="center">
            <v-col style="background:whitesmoke;border-radius:20px;border:2px solid white;padding:25px" xs="12" sm="12" md="6">
                            <h1>{{title}}</h1>
           <v-form ref="form" v-model="valid" lazy-validation>
              <v-row justify="center">
                <v-col md="5" sm="12">
                  <v-text-field v-model="names"
                   :rules="nameRules"
                    label="Nombres"
                    required>
                  </v-text-field>
    ...
    data : function(){
        return{
            ...
            lastnameRules: [
                ...
                lastname => lastname.length > 3 || "El apellido debe ser más largo a 3 caracteres"
            ],
            emailRules:[
